/* src/config/henga-config.h.  Generated from henga-config.h.in by configure.  */
/* src/config/henga-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://henga.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Henga Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Henga Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "henga"
