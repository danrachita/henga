...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NGH features */
        {"henga", "masternode", &masternode, true, true, false},
        {"henga", "masternodelist", &masternodelist, true, true, false},
        {"henga", "mnbudget", &mnbudget, true, true, false},
        {"henga", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"henga", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"henga", "mnsync", &mnsync, true, true, false},
        {"henga", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"henga", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use hengad, or the -server option to henga-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> henga-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28211/\n";
}
