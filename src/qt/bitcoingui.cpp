                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Henga-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Henga address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and henga: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Henga Core"), this);
    aboutAction->setStatusTip(tr("Show information about Henga Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Henga"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Henga addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Henga addresses"));
    ...
    openAction->setStatusTip(tr("Open a Henga: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Henga Core help message to get a list with possible Henga command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Henga Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Henga network", "", count));
}
...
{
    QString strTitle = tr("Henga Core"); // default title
