...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000005330a52f43afe97a20f967e63da82db7679abc4cea4b695e3466c2b7cf0"))
    (321357, uint256("0xa3f40e004f1c04964e4d914d4bd06c4c4d6a726b3b7583654e5cabd1989072b8"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1550009217, // * UNIX timestamp of last checkpoint block
    647364,    // * total number of transactions between genesis and last checkpoint
...
public:
	...
	nMasternodeColleteralLimxDev = 7000; //Params().MasternodeColleteralLimxDev()
        nModifierUpdateBlock = 1; // we use the version 2 for dmd
        nMaxMoneyOut = 210000000 * COIN;

        const char* pszTimestamp = "Henga Experiment Goes Live";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1530285891;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 25723113;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000005330a52f43afe97a20f967e63da82db7679abc4cea4b695e3466c2b7cf0"));
	...
	vSeeds.push_back(CDNSSeedData("45.77.218.101", "45.77.218.101"));
        ...
        nStartMasternodePayments = 1530285891; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1530285892;
        genesis.nNonce = 20722046;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000c117242df6a6b75259e2d37eab9e4165105bca19cae86996b9aa7e95b54"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Henga BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Henga BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Henga BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1530285892;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1530285893;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 6;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x158616fe6f77ae435f57b3113e666334cbe8ff78148d00fe00b37b20a6fc9926"));
