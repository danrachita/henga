...
#if defined(NDEBUG)
#error "Henga cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Henga Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 7600 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 7600 && nHeight <= 16000 ) {
	        nSubsidy = 60 * COIN;
	}else if( nHeight > 16000 && nHeight <= 36000 ) {
	        nSubsidy = 120 * COIN;
	} else if( nHeight > 36000 && nHeight <= 300000 ) {
	        nSubsidy = 40 * COIN;
	        ...
	        nSubsidy = 2 * COIN;
	} else if( nHeight > 800000 && nHeight <= 1500000 ) {
	        nSubsidy = 1 * COIN;
	} else {
		nSubsidy = 0.5 * COIN;
	}
