...
COINDOWNLOADLINK1=https://github.com/HengaCoin/henga/releases/download/v1.0/hengad
COINDOWNLOADLINK2=https://github.com/HengaCoin/henga/releases/download/v1.0/henga-cli
COINDOWNLOADLINK3=https://github.com/HengaCoin/henga/releases/download/v1.0/henga-tx
COINPORT=19441
COINRPCPORT=28211
COINDAEMON=hengad
COINDAEMONCLI=henga-cli
COINDAEMONTX=henga-tx
COINCORE=.henga
COINCONFIG=henga.conf
...
echo -e "------------------------------------------------------------"
echo -e "|                                                          |"
echo -e "|        ${BOLD}---- Henga masternode installer ----${NONE}        |"
echo -e "|                                                          |"
echo -e "------------------------------------------------------------"

echo -e "${BOLD}"
read -p "This script will install a Henga masternode wallet on your VPS. Do you wish to continue? (y/n)?" response
echo -e "${NONE}"
