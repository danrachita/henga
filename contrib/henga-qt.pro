...
RESOURCES += src/qt/henga.qrc src/qt/henga_locale.qrc

TRANSLATIONS += src/qt/locale/henga_bg.ts \
                src/qt/locale/henga_de.ts \
                src/qt/locale/henga_en.ts \
                src/qt/locale/henga_es.ts \
                src/qt/locale/henga_fi.ts \
                src/qt/locale/henga_fr.ts \
                src/qt/locale/henga_it.ts \
                src/qt/locale/henga_ja.ts \
                src/qt/locale/henga_pl.ts \
                src/qt/locale/henga_pt.ts \
                src/qt/locale/henga_ru.ts \
                src/qt/locale/henga_sk.ts \
                src/qt/locale/henga_sv.ts \
                src/qt/locale/henga_vi.ts \
                src/qt/locale/henga_zh_CN.ts \
                src/qt/locale/henga_zh_TW.ts
